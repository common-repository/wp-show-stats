...
Tags: wordpress statistics, wordpress statistics plugin, analysis, wordpress stats, custom post type stats, analysis plugin
...
= 1.3 =
* Made changes in CSS to resolve the styling conflicts occurred due to common class names.
= 1.4 =
* Upto version 1.3 the plugin was only visible at the backend for admin users only. Now there is one settings page to choose different roles to allow them access of this plugin.
= 1.4.2 =
* Added new chart on Users page to see number of users registered on a given day using date filters.
= 1.5 =
...
= 1.3 =
* Upgrade to newer version to avoid styling conflicts with other plugins.
= 1.4 =
* Upgrade to version 1.4 and allow access of this plugin to Editors, Authors, Contributors, etc... different roles.
= 1.4.2 =
* Upgrade to version 1.4.2 to see number of users registered on given day using date filters.
